...
import { n as normalizeComponent, c as cancelableClient, _, t as translate, V as VTooltip, N as NcInputField, C as CheckIcon, a as NcLoadingIcon, b as NcSettingsInputText, d as NcSettingsSection, s as showError, e as Vue } from "./NcSelect-BHnYbNPE.chunk.mjs";
const _sfc_main$1 = {
...
var SettingsKey = /* @__PURE__ */ ((SettingsKey2) => {
  ...
  SettingsKey2["FilesharingExpirationDays"] = "filesharing_expiration_days";
  return SettingsKey2;
})(SettingsKey || {});
/*! third party licenses: js/vendor.LICENSE.txt */
...
const SettingsMixin = {
  ...
  methods: {
    ...
    async getFilesharingExpirationDays() {
      const settings = await this.getSettings();
      return settings && settings.filesharingExpirationDays ? settings.filesharingExpirationDays : "";
    }
  }
};
/*! third party licenses: js/vendor.LICENSE.txt */
