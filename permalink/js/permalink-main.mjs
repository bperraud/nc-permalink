...
import { aE as normalizeComponent, f as cancelableClient, aI as showSuccess, aH as showError, J as NcActionButton, F as NcActions, aF as translate, V as Vue } from "./style-BJihKydM.chunk.mjs";
/*! third party licenses: js/vendor.LICENSE.txt */
const RequestMixin = {
  methods: {
...
var _sfc_render$3 = function render3() {
  var _vm = this, _c = _vm._self._c;
  return _c("span", _vm._b({ staticClass: "material-design-icon check-bold-icon", attrs: { "aria-hidden": _vm.title ? null : "true", "aria-label": _vm.title, "role": "img" }, on: { "click": function($event) {
    return _vm.$emit("click", $event);
  } } }, "span", _vm.$attrs, false), [_c("svg", { staticClass: "material-design-icon__svg", attrs: { "fill": _vm.fillColor, "width": _vm.size, "height": _vm.size, "viewBox": "0 0 24 24" } }, [_c("path", { attrs: { "d": "M9,20.42L2.79,14.21L5.62,11.38L9,14.77L18.88,4.88L21.71,7.71L9,20.42Z" } }, [_vm.title ? _c("title", [_vm._v(_vm._s(_vm.title))]) : _vm._e()])])]);
};
...
const _sfc_main$1 = {
  ...
  methods: {
    ...
    async onDelete() {
      ...
      try {
        const response = await cancelableClient.delete(`/ocs/v2.php/apps/permalink/api/link?path=${link}`);
        console.log("Response:", response);
