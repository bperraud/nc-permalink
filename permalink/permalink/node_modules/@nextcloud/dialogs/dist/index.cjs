...
const _pluginVue2_normalizer = require("./chunks/_plugin-vue2_normalizer-DrUYYh6X.cjs");
...
class FilePicker {
   ...
   */
  async pickNodes() {
    const { FilePickerVue } = await Promise.resolve().then(() => require("./chunks/index-BosH0tHn.cjs"));
