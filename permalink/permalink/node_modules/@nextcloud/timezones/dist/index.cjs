...
class TimezoneManager {
  ...
  registerTimezone(timezone) {
    ...
    ICAL__default.default.TimezoneService.register(timezone.timezoneId, timezone.toICALTimezone());
    this._pendingAliases = this._pendingAliases.filter(([aliasName, timezoneId]) => {
      if (timezoneId !== timezone.timezoneId) {
        return true;
      }
      ICAL__default.default.TimezoneService.register(aliasName, timezone.toICALTimezone());
      return false;
    });
  }
  ...
  registerAlias(aliasName, timezoneId) {
    ...
    ICAL__default.default.TimezoneService.register(aliasName, resolvedTimezone.toICALTimezone());
  }
  /**
  ...
  unregisterTimezones(timezoneId) {
    ...
    ICAL__default.default.TimezoneService.remove(timezoneId);
  }
  /**
  ...
  unregisterAlias(aliasName) {
    ...
    ICAL__default.default.TimezoneService.remove(aliasName);
  }
  /**
   * Clear all timezones
   */
  clearAllTimezones() {
    ...
    this._pendingAliases = [];
    this._timezones = /* @__PURE__ */ new Map();
    ICAL__default.default.TimezoneService.reset();
